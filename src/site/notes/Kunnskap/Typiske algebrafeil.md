...
I T-, R- og S-matte på videregående så er du nødt til å være god i algebra for å få vist kompetansen din hvis du ikke har hjelpemidler tilgjengelig. På denne siden har jeg samlet feil som elever ofte gjør.
...
**Det er ikke lov** siden telleren vår består av flere ledd. Her består telleren av leddene $2x(x+2)$ og $-1$. 
...
Tenk at forkorting av bokstavuttrykk er det samme som tall: du har kun lov til å forkorte dersom du har samme faktor i teller og nevner, og dersom du har flere ledd i teller eller nevner så må du faktorisere alle leddene.
...
Før du prøver å løse opp parentesen bør du spørre deg selv om det er nødvendig. For eksempel er uttrykket $(x+2)^{2}$ allerede et flott faktorisert uttrykk. 
...
$$
Hvis parentesen din inneholder flere ledd så kan det være du er nødt til å regne en del. Er parentesen opphøyd i 2 så kan du bruke kvadratsetninger, er den opphøyd i mer enn 2 så må du multiplisere sammen alle leddene.
...
Som dere ser er dette utrolig arbeidskrevende (det finnes noen triks for å gjøre detteenklere med bruk av [[Pascals trekant\|Pascals trekant]]), men det er likevel ikke noe jeg tror dere noengang trenger å gjøre i løpet av videregående. Hvis dere har eksponenten 3 eller høyere så ville jeg derfor ikke løst opp parentesen.

>[!important] Løse opp parentes med eksponent
