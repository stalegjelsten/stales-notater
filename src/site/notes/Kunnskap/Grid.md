...
Deretter velger du hvor mange rader og kolonner du ønsker i rutenettet ved hjelp av `grid-template-rows` og `grid-template-columns`. 


<div class="rutenett" style="display: grid;grid-template-rows: 2rem 20vh max(3rem, 10vh);grid-template-columns: repeat(2, 1fr) 2fr; padding: 1rem;">
  <div class="item" style="outline: 1px solid red;"></div>
  <div class="item" style="outline: 1px solid red;"></div>
  <div class="item" style="outline: 1px solid red;"></div>
  <div class="item" style="outline: 1px solid red;"></div>
  <div class="item" style="outline: 1px solid red;"></div>
...
I tillegg har jeg definert tre kolonner med verdiene `repeat(2, 1fr)` og `2fr`. Det betyr at vi skal repetere teksten `1fr` 32ganger. `1fr` er en brøkverdi som forteller hvor stor andel av den totale bredden kolonnene skal oppta. I vårt tilfelle har vi tilsammen 1+1+2=4 fr. Det betyr at 1fr tilsvarer 25% av bredden. Den siste kolonnen er `2fr`, eller dobbelt så bred.